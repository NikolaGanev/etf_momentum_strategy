...
def main():
    ...
    weights_path = root / "data" / "processed" / "weights_w120.parquet"
    ...
    results = run_backtest(
        ...
        cost_bps=10.0,          # transaction costs
        annualization=252
    )

    print("\n=== STEP 9 BACKTEST REPORT (SCALE, w=120) ===")
    ...
    out_path = root / "data" / "processed" / "backtest_daily_w120.parquet"
